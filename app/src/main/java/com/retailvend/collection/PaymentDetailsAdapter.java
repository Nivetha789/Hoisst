...
////    private List<PaymentDetailsDataModel> paymentDetailsDataModelList;
//    Context context;
//    String which;
//    String userid;
//
//    public PaymentDetailsAdapter(Context context,
////                                 List<PaymentDetailsDataModel> postItems,
//                                 String which, String userid) {
...
//    }
//
//    public void addItems(List<PaymentDetailsDataModel> postItems) {
//        paymentDetailsDataModelList.s2caddAll(postItems);
//        notifyDataSetChanged();
//    }
//
//    public void addLoading() {
//        isLoaderVisible = true;
//        paymentDetailsDataModelList.add(new PaymentDetailsDataModel());
...
//        PaymentDetailsDataModel item = getItem(position);
//        if (item != null) {
...
//    }
//
//    PaymentDetailsDataModel getItem(int position) {
...
//            PaymentDetailsDataModel item = paymentDetailsDataModelList.get(position);
//            txt_pay_type.setText(item.getType());
...
//            }
//            txt_pay_describ.setText("Discount : "+item.getDescription());
//
//            img_delete.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
//                    if (which.equals("customer")){
//                        ((PaymentDetailsActivity) context).deleteCustomerPaymentList("5",item.getId(),userid);
//                    }
//                    else {
//                        ((PaymentDetailsActivity) context).deleteSupplierPaymentList("5",item.getId(), userid);
//                    }
//
//
//                }
